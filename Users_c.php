...
class Users_c extends CI_Controller {
    ...
    public function validFormCoordonnes(){
        ...
        $this->form_validation->set_rules('nom','nom','trim|required|min_length[2]|max_length[30]');
        $this->form_validation->set_rules('login','login','trim|required|min_length[2]|max_length[30]');
        $this->form_validation->set_rules('password', 'password', 'trim|required|required|min_length[2]|max_length[30]');
        $this->form_validation->set_rules('email', 'email', 'required|required|min_length[2]|max_length[30]');
        $this->form_validation->set_rules('adresse','adresse','trim|required|min_length[2]|max_length[30]');
        $this->form_validation->set_rules('ville', 'ville', 'trim|required|required|min_length[2]|max_length[30]');
        $this->form_validation->set_rules('code_postal', 'code_postal', 'required|required|numeric');
